...
describe('useMirroredUniform', () => {
  ...
  describe('React StrictMode compatibility', () => {
    ...
    it('should handle buffer creation in normal mode', () => {
      const { result } = renderHook(() => useMirroredUniform(d.f32, 1.0), {
        wrapper: TestWrapper,
      });
    ...
    it('should handle value updates in StrictMode', () => {
      let value = 1.0;
      const { rerender } = renderHook(() => useMirroredUniform(d.f32, value), {
        wrapper: StrictModeWrapper,
      });
      ...
      expect({
        ...
        bufferNotRecreated:
          initialState.createUniformCallCount === createUniformMock.mock.calls.length,
      }).toMatchInlineSnapshot(`
        {
          "afterUpdate": {
            "createUniformCallCount": 2,
    ...
    it('should handle cleanup timeouts in StrictMode', async () => {
      const { unmount } = renderHook(() => useMirroredUniform(d.f32, 1.0), {
        wrapper: StrictModeWrapper,
      });
