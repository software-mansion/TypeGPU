...
export function useMirroredUniform<TSchema extends d.AnyWgslData, TValue extends d.Infer<TSchema>>(
  ...
  if (!d.deepEqual(currentSchemaRef.current as d.AnyData, schema as d.AnyData)) {
