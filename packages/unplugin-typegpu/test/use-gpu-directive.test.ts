  ...
  test('rollup', async () => {
    expect(await rollupTransform(code)).toMatchInlineSnapshot(`
      "const obj = {
          ...
          v: 2,
          name: "isPrime",
          ast: {"params":[{"type":"i","name":"n"}],"body":[0,[[11,[1,"n","<=",[5,"1"]],[0,[[10,false]]]],[14,[12,"i",[5,"2"]],[1,"i","<","n"],[102,"++","i"],[0,[[11,[1,[6,"obj.mod",["n","i"]],"===",[5,"0"]],[0,[[10,false]]]]]]],[10,true]]],"externalNames":["obj"]},
    ...
    expect(babelTransform(code)).toMatchInlineSnapshot(`
      ...
      const main = /*#__PURE__*/($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = (a, b) => {
        ...
        ast: {
          ...
          body: [0, [[12, "c", [1, [1, "a", "+", "b"], "+", [5, "2"]]], [2, "c", "+=", [1, [5, "2"], "*", "b"]], [2, "countMutable.$", "+=", [5, "3"]]]],
  ...
  test('rollup', async () => {
    expect(await rollupTransform(code)).toMatchInlineSnapshot(`
      ...
      const root = await tgpu.init();
          ...
          v: 2,
          name: "main",
          ast: {"params":[{"type":"i","name":"a"},{"type":"i","name":"b"}],"body":[0,[[12,"c",[1,[1,"a","+","b"],"+",[5,"2"]]],[2,"c","+=",[1,[5,"2"],"*","b"]],[2,"countMutable.$","+=",[5,"3"]]]],"externalNames":["countMutable"]},
...
describe('hoists default exported marked function statement', () => {
  const code = `\
    console.log(add);
...
describe('export marked arrow function', () => {
  const code = `\
  ...
  test('rollup', async () => {
    expect(await rollupTransform(code)).toMatchInlineSnapshot(`
      "const add = (/*#__PURE__*/($ => (globalThis.__TYPEGPU_META__ ??= new WeakMap()).set($.f = ((a, b) => {
          ...
          v: 1,
          name: "increment",
          ast: {"params":[{"type":"i","name":"n"}],"body":[0,[[10,[1,"n","+",[5,"1"]]]]],"externalNames":[]},
          externals: () => ({}),
        }) && $.f)({}));
      ...
      export { add, mul as default, increment };
      "
    `);
  });
});

describe('anonymous default export marked function statement', () => {
  const code = `\
  ...
  test('rollup', async () => {
    expect(await rollupTransform(code)).toMatchInlineSnapshot(`
      ...
      export { _virtual_code as default };
      "
    `);
  });
});

describe('anonymous default export marked arrow function', () => {
  const code = `\
    export default (a, b) => {
      'use gpu';
      return a + b;
