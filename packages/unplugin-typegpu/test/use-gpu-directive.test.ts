...
describe('[WEBPACK] "use gpu" directive', () => {
  let consoleWarnSpy: ReturnType<typeof vi.spyOn>;
  ...
  it('makes plugin transpile marked arrow functions passed to shells and keeps JS impl', async () => {
    ...
    expect(await webpackTransform(code)).toMatchInlineSnapshot(`
      ...
      /* harmony import */ var typegpu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
            ...
            const shell = typegpu__WEBPACK_IMPORTED_MODULE_0__["default"].fn([]);
  ...
  it('throws when hoisting was meant to be used', async () => {
    ...
    expect(consoleWarnSpy).toHaveBeenCalledWith(
      expect.stringContaining(
        `function "add" might have been referenced before its usage. Function statements are no longer hoisted after being transformed by the plugin.`,
      ),
    );
  });
    ...
    expect(await webpackTransform(code)).toMatchInlineSnapshot(`
      ...
      /* harmony import */ var typegpu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
            ...
            async function main() {
              ...
              const countMutable = root.createMutable(typegpu__WEBPACK_IMPORTED_MODULE_0__.d.i32, 0);
