 ...
 */
export const opUnion = tgpu.fn([d.f32, d.f32], d.f32)((d1, d2) => std.min(d1, d2));
 ...
 */
export const opSmoothUnion = tgpu.fn(
  [d.f32, d.f32, d.f32],
  d.f32,
)((d1, d2, k) => {
 ...
 * @param k Smoothing factor (larger k = more smoothing)
 */
export const opSmoothDifference = tgpu.fn(
  [d.f32, d.f32, d.f32],
  d.f32,
)((d1, d2, k) => {
  const h = std.max(k - std.abs(d1 + d2), 0) / k;
 ...
 */
export const opExtrudeZ = tgpu.fn(
  [d.vec3f, d.f32, d.f32],
  d.f32,
)((point, dd, halfHeight) => {
 ...
 */
export const opExtrudeX = tgpu.fn(
  [d.vec3f, d.f32, d.f32],
  d.f32,
)((point, dd, halfHeight) => {
 ...
 */
export const opExtrudeY = tgpu.fn(
  [d.vec3f, d.f32, d.f32],
  d.f32,
)((point, dd, halfHeight) => {
