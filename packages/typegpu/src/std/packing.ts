...
export const unpack2x16float = createDualImpl(
  ...
  // GPU implementation
  (e) => snip(stitch`unpack2x16float(${e})`, vec2f, /* ref */ undefined),
  'unpack2x16float',
);
...
export const pack2x16float = createDualImpl(
  ...
  // GPU implementation
  (e) => snip(stitch`pack2x16float(${e})`, u32, /* ref */ undefined),
  'pack2x16float',
);
...
export const unpack4x8unorm = createDualImpl(
  ...
  // GPU implementation
  (e) => snip(stitch`unpack4x8unorm(${e})`, vec4f, /* ref */ undefined),
  'unpack4x8unorm',
);
...
export const pack4x8unorm = createDualImpl(
  ...
  // GPU implementation
  (e) => snip(stitch`pack4x8unorm(${e})`, u32, /* ref */ undefined),
  'pack4x8unorm',
);
