...
export const unpack2x16float = createDualImpl(
  ...
  // GPU implementation
  (e) => snip(stitch`unpack2x16float(${e})`, vec2f, /* ref */ 'runtime'),
  'unpack2x16float',
);
...
export const pack2x16float = createDualImpl(
  ...
  // GPU implementation
  (e) => snip(stitch`pack2x16float(${e})`, u32, /* ref */ 'runtime'),
  'pack2x16float',
);
...
export const unpack4x8unorm = createDualImpl(
  ...
  // GPU implementation
  (e) => snip(stitch`unpack4x8unorm(${e})`, vec4f, /* ref */ 'runtime'),
  'unpack4x8unorm',
);
...
export const pack4x8unorm = createDualImpl(
  ...
  // GPU implementation
  (e) => snip(stitch`pack4x8unorm(${e})`, u32, /* ref */ 'runtime'),
  'pack4x8unorm',
);
