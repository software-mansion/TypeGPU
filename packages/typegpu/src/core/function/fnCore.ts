  ...
  const core = {
    ...
    resolve(
      ...
      if (typeof implementation === 'string') {
        ...
        // 'ref' of this snippet is unused, but I guess for the sake of
        // completeness, this is a reference to a function, so it's a ref.
        return snip(id, returnType, /* ref */ true);
      }
      ...
      // 'ref' of this snippet is unused, but I guess for the sake of
      // completeness, this is a reference to a function, so it's a ref.
      return snip(id, actualReturnType, /* ref */ true);
    },
  };
