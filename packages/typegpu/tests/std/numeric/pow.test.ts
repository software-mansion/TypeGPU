...
describe('pow', () => {
  ...
  it('should return the correct power for vectors', () => {
    expect(pow(vec2f(2, 3), vec2f(4, 5))).toEqual(vec2f(16, 243));
  });
