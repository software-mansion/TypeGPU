...
describe('tgpu.const', () => {
  ...
  it('cannot be mutated', () => {
    ...
    expect(() => tgpu.resolve([fn])).toThrowErrorMatchingInlineSnapshot(`
      ...
      - <root>
      - fn*:fn
      - fn*:fn(): 'boid.pos = vec3f()' is invalid, because boid.pos is a constant. This error may also occur when accidentally assigning to a value defined outside of a TypeGPU function.]
    `);
