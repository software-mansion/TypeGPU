...
describe('3d fish example', () => {
  ...
  it('should produce valid code', async ({ device }) => {
    ...
    expect(shaderCodes).toMatchInlineSnapshot(`
      "@group(0) @binding(0) var<uniform> seedUniform_2: f32;
      ...
      @group(0) @binding(1) var<storage, read_write> fish_data_0_9: array<ModelData_8, 8192>;

      @group(0) @binding(2) var<storage, read_write> fish_data_1_10: array<ModelData_8, 8192>;

      fn wrappedCallback_1(x: u32, _arg_1: u32, _arg_2: u32) {
        randSeed2_3(vec2f(f32(x), seedUniform_2));
        var data = ModelData_8(vec3f(((randFloat01_6() * 10) - 5), ((randFloat01_6() * 4) - 2), ((randFloat01_6() * 10) - 5)), vec3f(((randFloat01_6() * 0.1) - 0.05), ((randFloat01_6() * 0.1) - 0.05), ((randFloat01_6() * 0.1) - 0.05)), (0.07 * (1 + ((randFloat01_6() - 0.5) * 0.8))), randFloat01_6(), 1, 1, 1);
        fish_data_0_9[x] = data;
        fish_data_1_10[x] = data;
      }
      ...
      @compute @workgroup_size(256, 1, 1) fn mainCompute_0(in: mainCompute_Input_11)  {
      ...
      fn applySinWave_31(index: u32, vertex: PosAndNormal_29, time: f32) -> PosAndNormal_29 {
        var a = -60.1;
        var b = 0.8;
        var c = 6.1;
      ...
      @vertex fn vertexShader_24(input: vertexShader_Input_25) -> vertexShader_Output_26 {
        ...
        if ((currentModelData.applySinWave == 1)) {
          wavedVertex = applySinWave_31(input.instanceIndex, PosAndNormal_29(input.modelPosition, input.modelNormal), currentTime_30);
        }
      ...
      fn rgbToHsv_37(rgb: vec3f) -> vec3f {
        var r = rgb.x;
        var g = rgb.y;
        var b = rgb.z;
      ...
      fn hsvToRgb_38(hsv: vec3f) -> vec3f {
        var h = hsv.x;
        var s = hsv.y;
        var v = hsv.z;
        var i = floor((h * 6));
