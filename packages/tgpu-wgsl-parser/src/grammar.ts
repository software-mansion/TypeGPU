...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "struct_body_decl", "symbols": [{"literal":"{"}, "struct_member", "struct_body_decl$ebnf$1", "struct_body_decl$ebnf$2", {"literal":"}"}], "postprocess": ([ , first, rest]) => [first, ...rest.map(tuple => tuple[1])]},
