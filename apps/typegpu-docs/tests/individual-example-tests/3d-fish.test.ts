  ...
  it('should produce valid code', async ({ device }) => {
    ...
    expect(shaderCodes).toMatchInlineSnapshot(`
      ...
      @fragment fn fragmentShader(_arg_0: fragmentShader_Input) -> @location(0) vec4f {
        ...
        let cosTheta = dot(_arg_0.worldNormal, vec3f(-0.2357022762298584, 0.9428091049194336, -0.2357022762298584));
        ...
        let reflectSource = normalize(reflect(vec3f(0.2357022762298584, -0.9428091049194336, 0.2357022762298584), _arg_0.worldNormal));
