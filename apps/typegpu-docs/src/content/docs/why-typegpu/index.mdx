...
## TypeGPU and vanilla WebGPU

TypeGPU doesn't abstract away WebGPU in terms of capability, it provides utilities to write more efficient and maintainable WebGPU. Our primitives enable effortless
composition, making use of existing ESM import mechanisms to split shader code between files. Modules written in TypeGPU can be easily shared across projects, allowing
you to make use of our constantly growing ecosystem of utility packages.

## TypeGPU and other libraries

Most existing libraries (e.g. Three.js, Pixi.js) abstract away the complexity of WebGPU in return for conveniance, and make assumptions about what you're building.
Because the typegpu package itself is a usage-agnostic, and specific techniques and helpers are built as libraries on top of it, you can always swap out parts of the
ecosystem with your own implementations, and drill as deep as you'd like.
