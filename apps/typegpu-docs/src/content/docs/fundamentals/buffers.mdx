...
For buffers whose CPU-side data already lives in separate per-field arrays, see the <a href="#writing-struct-of-arrays-soa-data">SoA write section</a>.
