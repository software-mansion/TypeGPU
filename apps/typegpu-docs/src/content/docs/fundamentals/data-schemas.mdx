...
You can also call `d.arrayOf` without specifying the array length. This returns a partially applied schema function, allowing you to provide the length later or use schema to declare WGSL runtime-sized arrays.
