...
In the case of entry functions, you should not include the WGSL function header in the code string. Instead, the WGSL implementations need to access these arguments as passed in via structs.
