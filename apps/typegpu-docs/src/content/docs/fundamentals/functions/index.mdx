...
Builtin attributes are available on the `d.builtin` object. 
...
If you wish to, you can wrap any schema in the IO struct in a `d.location` decorator, however TypeGPU tries to assign locations automatically. 
