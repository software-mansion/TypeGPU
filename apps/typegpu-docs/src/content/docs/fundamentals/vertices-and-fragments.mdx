...
Where compute pipelines execute threads on a grid you define, render pipelines work in stages.
...
Unfortunately, there is no way change the thickness of the drawn points and lines. 
