...
// Assuming computePipeline is created with createComputePipeline
computePipeline.dispatchWorkgroups(16);

// Assuming computePipeline2 is created with createGuardedComputePipeline
computePipeline2.dispatchThreads(4);
```
