...
<CardGrid>
  <Card title="Buffers" icon="external">
    Flexible, general-purpose GPU memory. Buffers can store arbitrary data, as long as the layout is host-shareable.
  </Card>
  <Card title="Textures" icon="pen">
    Image-oriented GPU memory. Textures can also store non-image data, but they have their own rules, which we will cover later.
  </Card>
</CardGrid>
