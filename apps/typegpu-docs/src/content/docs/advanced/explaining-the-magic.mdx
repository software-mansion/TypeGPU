...
This could theoretically be done in runtime from the function's `toString`, but it would require bundling a JavaScript parser with TypeGPU, and catching externals would be really difficult.
