...
<ul class="list-disc pl-5">
  <li>
    ...
    Sooo, what is a [bind group?](/TypeGPU/apis/bind-groups/)
    A [bind group](/TypeGPU/apis/bind-groups/) is a set of variables, that can be bound to shaders through a pipeline, and accessed both in JS and WGSL code. 
    ...
    Fortunately, we can leave the tricky stuff to the TypeGPU - just define the schema for your data using [`data schemas`](/TypeGPU/apis/data-schemas/). Moreover, . What more, we can infer the bind group layout from the shader’s code. 
  </li>
  <li>
