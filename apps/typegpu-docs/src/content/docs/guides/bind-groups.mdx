...
This guide will cover all about typed bind groups and bind group layouts in TypeGPU.
We will go over how to use them with a simple example, and compare them to the WebGPU API.
