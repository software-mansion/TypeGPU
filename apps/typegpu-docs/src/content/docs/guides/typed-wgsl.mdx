...
+  computePass.setBindGroup(0, computeConstants.unwrap());

-  computePass.setBindGroup(1, computeBindGroup0);
+  computePass.setBindGroup(1, computeBindGroup0.unwrap());
...
+  computePass.setBindGroup(1, computeBindGroup1.unwrap());
  computePass.dispatchWorkgroups(
...
+    computePass.setBindGroup(1, computeBindGroup2.unwrap());
    computePass.dispatchWorkgroups(
      Math.ceil(srcWidth / blockDim),
      Math.ceil(srcHeight / batch[1])
    );
...
+  passEncoder.setBindGroup(0, showResultBindGroup.unwrap());
  passEncoder.draw(6);
  passEncoder.end();
