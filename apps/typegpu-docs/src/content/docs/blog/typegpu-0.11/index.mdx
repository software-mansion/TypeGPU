...
[More about these new APIs here](https://docs.swmansion.com/TypeGPU/apis/buffers/#writing-to-a-buffer).
...
[You can read more about .patch in the Buffers guide](/TypeGPU/apis/buffers/#patching-buffers).
...
[More about this API can be found in the Buffers guide.](/TypeGPU/apis/buffers/#writing-struct-of-arrays-soa-data)
...
For more, refer to [tgpu.unroll documentation.](/TypeGPU/apis/utils/#tgpuunroll).
