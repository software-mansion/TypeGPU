...
::::caution
This is an escape hatch. It replaces the flags TypeGPU would normally infer and marks the texture as usable through sampled, storage, and render APIs. Use it responsibly, and make sure the resulting `GPUTextureDescriptor` is valid.
::::
