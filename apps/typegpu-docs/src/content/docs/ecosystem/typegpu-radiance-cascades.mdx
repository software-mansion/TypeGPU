...
| `sdfSlot`, `colorSlot`, `rayMarchSlot`, `traceSegmentSlot`, `sdfResolutionAccess`, `renderAspectAccess`, `maxRayStepsAccess`, `rayMarchStepSafetyAccess` | Injection points used by the internal cascade compute pass |
