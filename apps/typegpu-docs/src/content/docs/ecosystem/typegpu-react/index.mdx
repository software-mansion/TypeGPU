...
The `useFrame` hook schedules the passed-in callback to be run every frame using `requestAnimationFrame`. The callback receives an object with the following properties:
