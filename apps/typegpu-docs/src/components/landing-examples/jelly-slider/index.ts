...
import { Slider } from '../../../examples/rendering/jelly-slider/slider.ts';
import { CameraController } from '../../../examples/rendering/jelly-slider/camera.ts';
import { EventHandler } from '../../../examples/rendering/jelly-slider/events.ts';
import {
  DirectionalLight,
  HitInfo,
  LineInfo,
  ...
  sampleLayout,
  SdfBbox,
} from '../../../examples/rendering/jelly-slider/dataTypes.ts';
import {
  beerLambert,
  ...
  fresnelSchlick,
  intersectBox,
} from '../../../examples/rendering/jelly-slider/utils.ts';
import { TAAResolver } from '../../../examples/rendering/jelly-slider/taa.ts';
import {
  AMBIENT_COLOR,
  AMBIENT_INTENSITY,
  AO_BIAS,
  ...
  SPECULAR_POWER,
  SURF_DIST,
} from '../../../examples/rendering/jelly-slider/constants.ts';
import { NumberProvider } from '../../../examples/rendering/jelly-slider/numbers.ts';
...
export default async function init(root: TgpuRoot, canvas: HTMLCanvasElement, signal: AbortSignal) {
  ...
  const renderBackground = (
    ...
    const posOffset = hitPosition.add(
      d
        .vec3f(0, 1, 0)
        .mul(offset * (originYBound / (1.0 + originYBound)) * (1 + randf.sample() / 2)),
    );
