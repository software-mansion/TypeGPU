...
description: A guide on state is managed through plums in wigsill.
---
...
<ol>
  <ListItem idx="A">
    ...
    Optimal when states updates more frequently than shaders are ran.
  ...
  <ListItem idx="B">
    ...
    Optimal when states updates are rarer than shader executions.
...
catch bugs and is usually not worth it. **wigsill** makes this a breeze.

```ts
import wgsl from 'wigsill';
import { struct, f32 } from 'wigsill/data';
